(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_category_List_vue"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
     ...
     */
    getImageDetails: function getImageDetails() {
      var _this = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this.axios.get('/api/uploader').then(function (response) {
    ...
    deleteCategory: function deleteCategory(id) {
      ...
      if (confirm("Are you sure to delete this Images Data ?")) {
        this.axios["delete"]("/api/uploader/".concat(id)).then(function (response) {
          _this2.getImageDetails();
        })["catch"](function (error) {
          console.log(error);
        });
      }
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "card-header" }, [
      _c("h4", [_vm._v("MULTIPLE IMAGE UPLODER")])
    ])
  },
  function() {
    var _vm = this
